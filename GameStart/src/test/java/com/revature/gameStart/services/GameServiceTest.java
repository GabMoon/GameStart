...
public class GameServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        games.add(new Game("ElfGame", "FoxGenre", "GoodDescription", 5,
                devs, pubs, plats));
        games.add(new Game("HighGame", "IceGenre", "JokeDescription", 4,
                devs, pubs, plats));
        games.add(new Game("KillerGame", "LostGenre", "MediocreDescription", 3,
                devs, pubs, plats));
    }
